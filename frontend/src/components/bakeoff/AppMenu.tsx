...
import { Menu, User, LogOut, MapPin, Heart, Bell, BarChart3, Building2, Wand2, Wallet, Scale, Moon, Sun, Undo2 } from "lucide-react";
    ...
    <div ref={ref} className="relative">
      ...
      {open && (
        <div className="bo-glass absolute right-0 top-12 z-[1300] w-56 rounded-2xl p-2">
          ...
          {item(<Bell className="h-4 w-4" />, "Saved searches", p.onSavedSearches)}
          ...
          {item(<Scale className="h-4 w-4" />, "BTO vs Resale", p.onBtoCompare)}
          {item(<Wallet className="h-4 w-4" />, "What can I afford?", p.onAfford)}
