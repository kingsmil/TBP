"""Deterministic HomeOS mock agent outputs for demos.

Mock mode keeps repository-derived facts and scoring in the normal services,
but replaces LLM narrative/chat calls with stable, readable copy.
"""
...
from app.services.homeos_ai_models import HomeOSAvatar, HomeOSPreferences
