        ...
        <div className="flex items-start justify-between gap-3">
          ...
          <div className="flex shrink-0 items-center gap-2">
            {activeCase && (
              <button
                type="button"
                title="Download case logs"
                onClick={() => {
                  const payload = {
                    case_id: activeCase.case_id,
                    profile_text: activeCase.profile_text,
                    avatar: activeCase.avatar,
                    conversation: activeCase.conversation,
                    pipeline: activeCase.pipeline,
                    shortlist: activeCase.shortlist,
                  ...
                  a.href = url;
                  a.download = `homeos-case-${activeCase.case_id.slice(0, 8)}.json`;
                  a.click();
